...
from apps.src.OCR.ocr_process import process_ocr
from apps.src.delete_files import delete_files
from apps.src.orientation_processing import extract_frames_from_video
from apps.src.sharpness_processing import calculate_sharpness
